...
class StaticAnalysisMemberReducerJxPath21fTest : StaticAnalysisMemberReducerIntegTest() {

    override val project = TestProjects.JxPath21f

    @Nested
    inner class JXPath151Test {

        @Nested
        inner class TestMapValueEquality : OnTestCase("org.apache.commons.jxpath.ri.model.JXPath151Test::testMapValueEquality", true) {
             ...
             *   at org.apache.commons.jxpath.ri.model.JXPath151Test.setUp(JXPath151Test.java:37)
             * ```
             */
            @Test
            ...
            fun `Regression-00`() {
                run {
                    val cu = reducer.context.getCUByPrimaryTypeName("org.apache.commons.jxpath.ri.model.JXPath151Test")
                    assumeTrue(cu != null)
