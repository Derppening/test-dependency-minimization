...
class StaticAnalysisMemberReducerJxPath22fTest : StaticAnalysisMemberReducerIntegTest() {

    override val project = TestProjects.JxPath22f

    @Nested
    inner class JXPath154Test {

        @Nested
        inner class TestInnerEmptyNamespaceDOM : OnTestCase("org.apache.commons.jxpath.ri.model.JXPath154Test::testInnerEmptyNamespaceDOM", true) {
            ...
            fun testExecution() {
                ...
                project.copyProjectFile(Path("src/test/org/apache/commons/jxpath/InnerEmptyNamespace.xml"), outputDir!!.path)
             ...
             *   at org.apache.commons.jxpath.ri.model.JXPath154Test.doTest(JXPath154Test.java:16)
            ...
            fun `Regression-00`() {
                run {
                    val cu = reducer.context.getCUByPrimaryTypeName("org.apache.commons.jxpath.ri.model.JXPath154Test")
                    assumeTrue(cu != null)

                    val method = cu.primaryType.get()
                        .getMethodsBySignature("testInnerEmptyNamespaceDOM").single()
                ...
                run {
                    ...
                    val method = cu.primaryType.get()
                        .getMethodsBySignature("doTest", "String", "String", "String").single()
