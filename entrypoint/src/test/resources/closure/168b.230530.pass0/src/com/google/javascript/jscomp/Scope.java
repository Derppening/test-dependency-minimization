...
public class Scope implements StaticScope<JSType>, StaticSymbolTable<Scope.Var, Scope.Var> {
    ...
    public static class Var implements StaticSlot<JSType>, StaticReference<JSType> {
         ...
         */
        private Var(boolean inferred, String name, Node nameNode, JSType type, Scope scope, int index, CompilerInput input, boolean isDefine, JSDocInfo info) {
            this.name = name;
        ...
        public Var getDeclaration() {
            throw new AssertionError("This method should not be reached! Signature: getDeclaration()");
        }
