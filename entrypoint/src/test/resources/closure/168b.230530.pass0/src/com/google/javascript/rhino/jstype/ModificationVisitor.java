...
public class ModificationVisitor implements Visitor<JSType> {
    ...
    private ObjectType coerseToThisType(JSType type) {
        ...
        ObjectType restricted = type.restrictByNotNullOrUndefined().collapseUnion().toObjectType();
        return restricted != null ? restricted : registry.getNativeObjectType(JSTypeNative.UNKNOWN_TYPE);
    }
    ...
    public JSType caseTemplateType(TemplateType type) {
        throw new AssertionError("This method should not be reached! Signature: caseTemplateType(TemplateType)");
    }
