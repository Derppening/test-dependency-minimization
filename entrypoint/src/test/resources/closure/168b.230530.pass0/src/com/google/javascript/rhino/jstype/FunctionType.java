...
public class FunctionType extends PrototypeObjectType {
     ...
     */
    FunctionType(JSTypeRegistry registry, String name, Node source, ArrowType arrowType, ObjectType typeOfThis, ImmutableList<String> templateTypeNames, boolean isConstructor, boolean nativeType) {
        ...
        this.call = arrowType;
        this.templateTypeNames = templateTypeNames != null ? templateTypeNames : ImmutableList.<String>of();
    }
