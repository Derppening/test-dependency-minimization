...
class ProxyObjectType extends ObjectType {
    ...
    public JSType getPropertyType(String propertyName) {
        return referencedObjType == null ? getNativeType(JSTypeNative.UNKNOWN_TYPE) : referencedObjType.getPropertyType(propertyName);
    }
    ...
    public Set<String> getOwnPropertyNames() {
        return referencedObjType == null ? ImmutableSet.<String>of() : referencedObjType.getOwnPropertyNames();
    }
