...
public class SimpleDependencyInfo implements DependencyInfo {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equal(other.srcPathRelativeToClosure, srcPathRelativeToClosure) && Objects.equal(other.pathOfDefiningFile, pathOfDefiningFile) && Objects.equal(other.requires, this.requires) && Objects.equal(other.provides, this.provides);
    }

    @Override
    public String toString() {
        return String.format("DependencyInfo(relativePath='%1$s', path='%2$s', " + "provides=%3$s, requires=%4$s)", srcPathRelativeToClosure, pathOfDefiningFile, provides, requires);
    }
}
