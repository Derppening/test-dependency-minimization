...
public abstract class ChainableReverseAbstractInterpreter implements ReverseAbstractInterpreter {
    ...
    abstract class RestrictByTrueTypeOfResultVisitor extends RestrictByTypeOfResultVisitor {
        ...
        @Override
        public JSType caseFunctionType(FunctionType type) {
            throw new AssertionError("This method should not be reached! Signature: caseFunctionType(FunctionType)");
        }
        ...
        @Override
        public JSType caseObjectType(ObjectType type) {
            throw new AssertionError("This method should not be reached! Signature: caseObjectType(ObjectType)");
        }
