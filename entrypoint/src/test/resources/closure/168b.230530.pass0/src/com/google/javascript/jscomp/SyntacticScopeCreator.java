...
class SyntacticScopeCreator implements ScopeCreator {
    ...
    SyntacticScopeCreator(AbstractCompiler compiler, RedeclarationHandler redeclarationHandler) {
        this.compiler = null;
        this.redeclarationHandler = null;
        throw new AssertionError("This method should not be reached! Signature: SyntacticScopeCreator(AbstractCompiler, RedeclarationHandler)");
    }
