...
public class CodingConventions {
    ...
    private CodingConventions() {
        throw new AssertionError("This method should not be reached! Signature: CodingConventions()");
    }
    ...
    public static class Proxy implements CodingConvention {
        ...
        public boolean isOptionalParameter(Node parameter) {
            throw new AssertionError("This method should not be reached! Signature: isOptionalParameter(Node)");
        }

        @Override
        public boolean isVarArgsParameter(Node parameter) {
            throw new AssertionError("This method should not be reached! Signature: isVarArgsParameter(Node)");
        }
