...
public class ClosureCodingConvention extends CodingConventions.Proxy {
    ...
    public void applySubclassRelationship(FunctionType parentCtor, FunctionType childCtor, SubclassType type) {
        ...
        if (type == SubclassType.INHERITS) {
            ...
            childCtor.getPrototype().defineDeclaredProperty("constructor", // Notice that constructor functions do not need to be covariant
            // on the superclass.
            ...
            childCtor.cloneWithoutArrowType(), childCtor.getSource());
        }
    }
