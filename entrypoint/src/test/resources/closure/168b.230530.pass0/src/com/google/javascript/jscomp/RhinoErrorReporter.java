...
class RhinoErrorReporter {
    ...
    private RhinoErrorReporter(AbstractCompiler compiler) {
        ...
        typeMap = ImmutableMap.of(// Trailing comma
        replacePlaceHolders(com.google.javascript.rhino.head.ScriptRuntime.getMessage0("msg.extra.trailing.comma")), TRAILING_COMMA, // Duplicate parameter
        replacePlaceHolders(com.google.javascript.rhino.head.ScriptRuntime.getMessage0("msg.dup.parms")), DUPLICATE_PARAM, // Unknown @annotations.
        replacePlaceHolders(ScriptRuntime.getMessage0("msg.bad.jsdoc.tag")), BAD_JSDOC_ANNOTATION, // Type annotation errors.
        Pattern.compile("^Bad type annotation.*"), TYPE_PARSE_ERROR);
    }
    ...
    private static class NewRhinoErrorReporter extends RhinoErrorReporter implements com.google.javascript.rhino.head.ast.IdeErrorReporter {
