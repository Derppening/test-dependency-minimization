...
public class NoObjectType extends FunctionType {
    ...
    private class LeastSupertypeVisitor implements Visitor<JSType>, Serializable {
        ...
        public JSType caseBooleanType() {
            return registry.createUnionType(JSTypeNative.NO_OBJECT_TYPE, JSTypeNative.BOOLEAN_TYPE);
        }
        ...
        public JSType caseNullType() {
            return registry.createUnionType(JSTypeNative.NO_OBJECT_TYPE, JSTypeNative.NULL_TYPE);
        }

        public JSType caseNumberType() {
            return registry.createUnionType(JSTypeNative.NO_OBJECT_TYPE, JSTypeNative.NUMBER_TYPE);
        }
        ...
        public JSType caseStringType() {
            return registry.createUnionType(JSTypeNative.NO_OBJECT_TYPE, JSTypeNative.STRING_TYPE);
        }

        public JSType caseUnionType(UnionType type) {
            return registry.createUnionType(getNativeType(JSTypeNative.NO_OBJECT_TYPE), type);
        }
        ...
        public JSType caseVoidType() {
            return registry.createUnionType(JSTypeNative.NO_OBJECT_TYPE, JSTypeNative.VOID_TYPE);
        }
    }
