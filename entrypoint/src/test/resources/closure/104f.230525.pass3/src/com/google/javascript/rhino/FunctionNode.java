...
public class FunctionNode extends ScriptOrFnNode {
    ...
    public FunctionNode(String name) {
        ...
        throw new AssertionError("This method should not be reached! Signature: FunctionNode(String)");
    }

    public FunctionNode(String name, int lineno, int charno) {
        super(Token.FUNCTION, lineno, charno);
        throw new AssertionError("This method should not be reached! Signature: FunctionNode(String, int, int)");
    }
