...
public class FunctionType extends PrototypeObjectType {
     ...
     */
    @VisibleForTesting
    public FunctionType(JSTypeRegistry registry, String name, Node source, Node parameters, JSType returnType) {
     ...
     */
    FunctionType(JSTypeRegistry registry, String name, Node source, Node parameters, JSType returnType, ObjectType typeOfThis, String templateTypeName, boolean isConstructor, boolean nativeType) {
    ...
    FunctionType(JSTypeRegistry registry, String name, Node source) {
        ...
        this.kind = null;
        throw new AssertionError("This method should not be reached! Signature: FunctionType(JSTypeRegistry, String, Node)");
    }
