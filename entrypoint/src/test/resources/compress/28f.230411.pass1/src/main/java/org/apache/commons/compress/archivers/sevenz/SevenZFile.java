...
public class SevenZFile implements Closeable {
    ...
    static final byte[] sevenZSignature = { (byte) '7', (byte) 'z', (byte) 0xBC, (byte) 0xAF, (byte) 0x27, (byte) 0x1C };
    ...
    public SevenZFile(final File filename, final byte[] password) throws IOException {
        archive = null;
        throw new AssertionError("This method should not be reached! Signature: SevenZFile(File, byte[])");
    }
    ...
    private StartHeader readStartHeader(final long startHeaderCrc) throws IOException {
        ...
        try {
            dataInputStream = new DataInputStream(new CRC32VerifyingInputStream(new BoundedRandomAccessFileInputStream(file, 20), 20, startHeaderCrc));
    ...
    private DataInputStream readEncodedHeader(final DataInputStream header, final Archive archive, byte[] password) throws IOException {
        readStreamsInfo(header, archive);
        ...
        InputStream inputStreamStack = new BoundedRandomAccessFileInputStream(file, archive.packSizes[firstPackStreamIndex]);
