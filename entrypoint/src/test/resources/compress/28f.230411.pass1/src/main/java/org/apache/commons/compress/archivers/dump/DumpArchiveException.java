...
public class DumpArchiveException extends IOException {
    ...
    public DumpArchiveException() {
        throw new AssertionError("This method should not be reached! Signature: DumpArchiveException()");
    }
    ...
    public DumpArchiveException(Throwable cause) {
        throw new AssertionError("This method should not be reached! Signature: DumpArchiveException(Throwable)");
    }
