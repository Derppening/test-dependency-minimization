...
public class ZipFile implements Closeable {
    ...
    public ZipFile(File f, String encoding, boolean useUnicodeExtraFields) throws IOException {
        ...
        archive = null;
        throw new AssertionError("This method should not be reached! Signature: ZipFile(File, String, boolean)");
    }
     ...
     */
    private static final int CFH_LEN = /* version made by                 */
     ...
     * comment.
     */
    static final int MIN_EOCD_SIZE = /* end of central dir signature    */
     ...
     * file comment.
     */
    private static final int MAX_EOCD_SIZE = MIN_EOCD_SIZE + /* maximum length of zipfile comment */
    ZIP64_MAGIC_SHORT;
     ...
     * record".
     */
    private static final int CFD_LOCATOR_OFFSET = /* end of central dir signature    */
    WORD + /* number of this disk             */
    SHORT + /* number of the disk with the     */
    /* start of the central directory  */
    SHORT + /* total number of entries in      */
     ...
     */
    private static final int ZIP64_EOCDL_LENGTH = /* zip64 end of central dir locator sig */
    WORD + /* number of the disk with the start    */
    /* start of the zip64 end of            */
    /* central directory                    */
    WORD + /* relative offset of the zip64         */
    /* end of central directory record      */
    DWORD + /* total number of disks                */
    WORD;
     ...
     */
    private static final int ZIP64_EOCDL_LOCATOR_OFFSET = /* zip64 end of central dir locator sig */
    WORD + /* number of the disk with the start    */
    /* start of the zip64 end of            */
    /* central directory                    */
    WORD;
     ...
     */
    private static final int ZIP64_EOCD_CFD_LOCATOR_OFFSET = /* zip64 end of central dir        */
    /* signature                       */
    WORD + /* size of zip64 end of central    */
    /* directory record                */
    DWORD + /* version made by                 */
    SHORT + /* version needed to extract       */
    SHORT + /* number of this disk             */
    WORD + /* number of the disk with the     */
    /* start of the central directory  */
    WORD + /* total number of entries in the  */
    /* central directory on this disk  */
    DWORD + /* total number of entries in the  */
    /* central directory               */
     ...
     * filename&quot; entry.
     */
    private static final long LFH_OFFSET_FOR_FILENAME_LENGTH = /* local file header signature     */
    ...
    private static class Entry extends ZipArchiveEntry {
        ...
        public boolean equals(Object other) {
            if (super.equals(other)) {
                ...
                return offsetEntry.headerOffset == otherEntry.offsetEntry.headerOffset && offsetEntry.dataOffset == otherEntry.offsetEntry.dataOffset;
            }
            return false;
        }
    }
