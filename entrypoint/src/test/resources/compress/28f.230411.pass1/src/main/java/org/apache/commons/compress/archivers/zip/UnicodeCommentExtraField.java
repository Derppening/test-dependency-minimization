...
public class UnicodeCommentExtraField extends AbstractUnicodeExtraField {
    ...
    public UnicodeCommentExtraField() {
        throw new AssertionError("This method should not be reached! Signature: UnicodeCommentExtraField()");
    }
    ...
    public UnicodeCommentExtraField(String comment, byte[] bytes) {
        super(comment, bytes);
        throw new AssertionError("This method should not be reached! Signature: UnicodeCommentExtraField(String, byte[])");
    }
