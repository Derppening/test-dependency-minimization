...
public class Zip64ExtendedInformationExtraField implements ZipExtraField {
    ...
    public Zip64ExtendedInformationExtraField(ZipEightByteInteger size, ZipEightByteInteger compressedSize, ZipEightByteInteger relativeHeaderOffset, ZipLong diskStart) {
        throw new AssertionError("This method should not be reached! Signature: Zip64ExtendedInformationExtraField(ZipEightByteInteger, ZipEightByteInteger, ZipEightByteInteger, ZipLong)");
    }
