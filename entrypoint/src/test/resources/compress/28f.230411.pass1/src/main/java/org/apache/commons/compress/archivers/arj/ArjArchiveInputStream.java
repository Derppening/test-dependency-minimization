...
public class ArjArchiveInputStream extends ArchiveInputStream {
    ...
    private MainHeader readMainHeader() throws IOException {
        ...
        // count has already counted them via readFully
        pushedBackBytes(20);
    ...
    public ArjArchiveEntry getNextEntry() throws IOException {
        ...
        if (currentLocalFileHeader != null) {
            ...
            if (currentLocalFileHeader.method == LocalFileHeader.Methods.STORED) {
                currentInputStream = new CRC32VerifyingInputStream(currentInputStream, currentLocalFileHeader.originalSize, currentLocalFileHeader.originalCrc32);
            }
