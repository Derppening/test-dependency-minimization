...
public class UnicodePathExtraField extends AbstractUnicodeExtraField {
    ...
    public UnicodePathExtraField() {
        throw new AssertionError("This method should not be reached! Signature: UnicodePathExtraField()");
    }
    ...
    public UnicodePathExtraField(String name, byte[] bytes) {
        super(name, bytes);
        throw new AssertionError("This method should not be reached! Signature: UnicodePathExtraField(String, byte[])");
    }
